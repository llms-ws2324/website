...
The goal of the final project is for you to create a LLM application of your own choosing and effectively communicate the results (using the concepts and technology we covered in this course).
